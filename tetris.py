...
while not done:
    ...
    font = pygame.font.SysFont('Corbel', 24, True, False)
    font1 = pygame.font.SysFont('Corbel', 60, True, False)
    text_score = font.render("Score: " + str(game.score), True, BLACK)
    text_pieces = font.render("Pieces: " + str(game.pieces), True, BLACK)
    text_game_over = font1.render("Game Over", True, (255, 125, 0))
    text_game_over1 = font1.render("Press ESC", True, (255, 215, 0))

    screen.blit(text_score, [4, 4])
    screen.blit(text_pieces, [4, 24])
